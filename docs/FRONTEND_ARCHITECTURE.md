...
- Finance (Phase 2A–2B): `/app/f/[familyId]/finance` (+ budgets / accounts / transactions / categories); TanStack Query for summary, budgets, accounts, categories, transactions; amounts formatted as IDR strings — never JS floats for money math; budget progress is server-authored
